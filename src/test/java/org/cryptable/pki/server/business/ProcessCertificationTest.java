...
import org.cryptable.pki.server.model.profile.ProfilesCRLDistributionPointsTest;
...
public class ProcessCertificationTest {
	...
	public void testCertificationRequest() throws NoSuchAlgorithmException,
		...
		logger.debug(x509CertificateHolder2.getSubject().toString());
		logger.debug(x509CertificateHolder2.getIssuer().toString());
		logger.debug(x509CertificateHolder.getIssuer().toString());
